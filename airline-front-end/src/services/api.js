...
// Aircraft Navigation
export const getAircraftNavigation = () => axios.get(`${API_BASE_URL}/aircraft-navigation`);
// export const getAircraftNavigationById = (id) => axios.get(`${API_BASE_URL}/aircraft-navigation/${id}`);
export const createAircraftNavigation = (data) => axios.post(`${API_BASE_URL}/aircraft-navigation`, data);
// export const updateAircraftNavigation = (id, data) => axios.put(`${API_BASE_URL}/aircraft-navigation/${id}`, data);
// export const deleteAircraftNavigation = (id) => axios.delete(`${API_BASE_URL}/aircraft-navigation/${id}`);
